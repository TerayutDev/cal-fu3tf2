...
export class OrderComponent  implements OnInit {
  ...
  @ViewChild(IonModal)
  modal!: IonModal;
  orderList:IOrderService.OrderList[]=[];
  savebtn=false;
  digisSelect=0;
...
return this._systemNumber.checkDigisNumber(event.target.value,2);
  ...
  ngOnInit() {
    this.orderList.push({roundId:1,typeLotto:'2 ตัวบน',numberList:[
      {number:'22',totalPrice:800},
      {number:'99',totalPrice:400},
      {number:'13',totalPrice:1000},
      {number:'19',totalPrice:300},
    ]});
  }
